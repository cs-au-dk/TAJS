...
public final class ScopeChain {
	...
	public static ScopeChain make(ObjectLabel obj) {
		return make(Collections.singleton(obj), (ScopeChain)null);
	}
	...
	public static ScopeChain summarize(ScopeChain sc, Summarized s) {
		return summarize(sc, s, dk.brics.tajs.util.Collections.<ScopeChain,ScopeChain>newMap());
	}
	 ...
	 */
	public static Iterable<Set<ObjectLabel>> iterable(final ScopeChain s) {
		if (s == null)
