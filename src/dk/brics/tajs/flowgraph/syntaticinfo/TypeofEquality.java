...
/**
 * An equality comparison between the typeof a value and a value in a condition.
 */
public class TypeofEquality extends AbstractEquality {

    public TypeofEquality(SyntacticReference reference, int comparateeRegister, boolean isStrict, boolean negated) {
