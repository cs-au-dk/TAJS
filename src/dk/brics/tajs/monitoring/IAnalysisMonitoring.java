 ...
 */
public interface IAnalysisMonitoring<BlockStateType extends BlockState<BlockStateType, ContextType, CallEdgeType>,
        ContextType extends IContext<ContextType>,
        CallEdgeType extends CallEdge<BlockStateType>> extends IMonitoring<BlockStateType, ContextType> {
     ...
     */
    void visitReadThis(ReadVariableNode n, Value v, BlockStateType state, ObjectLabel global_obj);
     ...
     * @param v the value being read
     */
    void visitReadVariable(ReadVariableNode n, Value v, BlockStateType state);
     ...
     * @param state current abstract state
     */
    void visitWriteVariable(WriteVariableNode n, Value v, BlockStateType state);
     ...
     * @param state       current abstract state
     */
    void visitReadProperty(ReadPropertyNode n, Set<ObjectLabel> objlabels, Str propertystr, boolean maybe, BlockStateType state);
     ...
     */
    void visitPropertyRead(Node n, Set<ObjectLabel> objs, Str propertystr, BlockStateType state, boolean check_unknown);
     ...
     */
    void visitVariableOrProperty(String var, SourceLocation loc, Value value, IContext<ContextType> context, BlockStateType state);
     ...
     */
    void visitRead(Node n, Value v, BlockStateType state);
     ...
     */
    void visitVariableAsRead(ReadVariableNode n, Value v, BlockStateType state);

    /**
     * Produces output showing the parts of the code that is determined unreachable by the analysis.
     */
    void logUnreachableMap();
