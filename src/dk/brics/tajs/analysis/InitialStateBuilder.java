...
public class InitialStateBuilder implements IInitialStateBuilder<State, Context, CallEdge, IAnalysisMonitoring, Analysis> { // TODO: to be replaced by the host model system
    ...
    public void addInitialState(BasicBlock global_entry_block, GenericSolver<State, Context, CallEdge, IAnalysisMonitoring, Analysis>.SolverInterface c, Source document) {
        ...
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_DUMPVALUE, ECMAScriptObjects.TAJS_DUMPVALUE.toString(), 1);
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_DUMPPROTOTYPE, ECMAScriptObjects.TAJS_DUMPPROTOTYPE.toString(), 1);
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_DUMPOBJECT, ECMAScriptObjects.TAJS_DUMPOBJECT.toString(), 1);
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_DUMPSTATE, ECMAScriptObjects.TAJS_DUMPSTATE.toString(), 0);
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_DUMPMODIFIEDSTATE, ECMAScriptObjects.TAJS_DUMPMODIFIEDSTATE.toString(), 0);
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_DUMPATTRIBUTES, ECMAScriptObjects.TAJS_DUMPATTRIBUTES.toString(), 2);
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_DUMPEXPRESSION, ECMAScriptObjects.TAJS_DUMPEXPRESSION.toString(), 1);
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_DUMPNF, ECMAScriptObjects.TAJS_DUMPNF.toString(), 1);
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_CONVERSION_TO_PRIMITIVE, ECMAScriptObjects.TAJS_CONVERSION_TO_PRIMITIVE.toString(), 2);
        ...
        createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_ASSERT, ECMAScriptObjects.TAJS_ASSERT.toString(), 3);
        ...
        if (Options.get().isDOMEnabled()) {
            ...
            createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_GET_UI_EVENT, ECMAScriptObjects.TAJS_GET_UI_EVENT.toString(), 0);
            createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_GET_MOUSE_EVENT, ECMAScriptObjects.TAJS_GET_MOUSE_EVENT.toString(), 0);
            createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_GET_KEYBOARD_EVENT, ECMAScriptObjects.TAJS_GET_KEYBOARD_EVENT.toString(), 0);
            createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_GET_EVENT_LISTENER, ECMAScriptObjects.TAJS_GET_EVENT_LISTENER.toString(), 0);
            createPrimitiveFunction(s, global, lFunProto, ECMAScriptObjects.TAJS_GET_WHEEL_EVENT, ECMAScriptObjects.TAJS_GET_WHEEL_EVENT.toString(), 0);

            DOMBuilder.addInitialState(s, document);
        }
        ...
        if (Options.get().isDOMEnabled()) {
            for (Entry<EventHandlerKind, Collection<Function>> me : c.getFlowGraph().getEventHandlers().entrySet()) {
                ...
                for (Function f : me.getValue()) {
                    createAndRegisterEventHandler(s, f, e);
                }
            }
        }
     ...
     */
    private static void createAndRegisterEventHandler(State s, Function f, EventHandlerKind kind) {
        if (Options.get().isDOMEnabled()) {
            switch (kind) {
                case LOAD:
