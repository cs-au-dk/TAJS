    ...
    public static Value evaluate(DOMObjects nativeobject, FunctionCalls.CallInfo call, State s, Solver.SolverInterface c) {
        switch (nativeobject) {
            case CHARACTERDATA_APPENDDATA: {
                ...
                /* Value arg =*/ Conversion.toString(NativeFunctions.readParameter(call, s, 0), c);
                return Value.makeUndef();
            }
            case CHARACTERDATA_DELETEDATA: {
                NativeFunctions.expectParameters(nativeobject, call, c, 2, 2);
                /* Value offset =*/ Conversion.toNumber(NativeFunctions.readParameter(call, s, 0), c);
                /* Value count =*/ Conversion.toNumber(NativeFunctions.readParameter(call, s, 1), c);
                return Value.makeUndef();
            }
            case CHARACTERDATA_REPLACEDATA: {
                ...
                /* Value offset =*/ Conversion.toNumber(NativeFunctions.readParameter(call, s, 0), c);
                /* Value count =*/ Conversion.toNumber(NativeFunctions.readParameter(call, s, 1), c);
                /* Value arg =*/ Conversion.toString(NativeFunctions.readParameter(call, s, 2), c);
                return Value.makeUndef();
            }
            ...
            case CHARACTERDATA_INSERTDATA: {
                NativeFunctions.expectParameters(nativeobject, call, c, 2, 2);
                /* Value offset =*/ Conversion.toNumber(NativeFunctions.readParameter(call, s, 0), c);
                /* Value arg =*/ Conversion.toString(NativeFunctions.readParameter(call, s, 1), c);
                return Value.makeUndef();
            }
            default:
