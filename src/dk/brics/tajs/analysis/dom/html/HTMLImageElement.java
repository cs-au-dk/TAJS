...
public class HTMLImageElement {
    ...
    public static void build(State s) {
        ...
        // HTML5
        createDOMProperty(s, HTMLImageElement.INSTANCES, "naturalWidth", Value.makeAnyNumUInt().setReadOnly());
        createDOMProperty(s, HTMLImageElement.INSTANCES, "naturalHeight", Value.makeAnyNumUInt().setReadOnly());
