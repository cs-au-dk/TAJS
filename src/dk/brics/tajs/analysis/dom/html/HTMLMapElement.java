...
public class HTMLMapElement {
    ...
    public static void build(State s) {
        ...
        s.writeProperty(DOMWindow.WINDOW, "HTMLMapElement", Value.makeObject(CONSTRUCTOR));
         ...
         */
        // DOM Level 1
        createDOMProperty(s, INSTANCES, "areas", Value.makeObject(HTMLCollection.INSTANCES).setReadOnly());
