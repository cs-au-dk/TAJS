...
public class HTMLHtmlElement {
    ...
    public static void build(State s) {
        ...
        s.writeProperty(DOMWindow.WINDOW, "HTMLHtmlElement", Value.makeObject(CONSTRUCTOR));
         ...
         */
        // DOM Level 0
        createDOMProperty(s, INSTANCES, "clientWidth", Value.makeAnyStr());
        createDOMProperty(s, INSTANCES, "clientHeight", Value.makeAnyStr());

        // DOM Level 1
        createDOMProperty(s, INSTANCES, "version", Value.makeAnyStr());
