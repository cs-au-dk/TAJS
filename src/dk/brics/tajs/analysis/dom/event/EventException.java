...
public class EventException {
    ...
    public static void build(State s) {
        ...
        s.writeProperty(DOMWindow.WINDOW, "EventException", Value.makeObject(CONSTRUCTOR));
         ...
         * Properties.
         */
        createDOMProperty(s, INSTANCES, "code", Value.makeAnyNumUInt());
         ...
         * Constants.
         */
        createDOMProperty(s, PROTOTYPE, "UNSPECIFIED_EVENT_TYPE_ERR", Value.makeNum(0));
