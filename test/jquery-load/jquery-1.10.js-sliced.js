 ...
 */
    (function(window, undefined) {
        ...
        expando = "sizzle" + "TAJS_UUID", preferredDoc = window.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), hasDuplicate = false, sortOrder = function() {
            return 0;
...
//            break;
    ...
    jQuery.each([ "tabIndex", "readOnly", "maxLength", "cellSpacing", "cellPadding", "rowSpan", "colSpan", "useMap", "frameBorder", "contentEditable" ], function(ARG1) {
    ...
    jQuery.each([ "radio", "checkbox" ], function(ARG1) {
 ...
 */
    ...
    jQuery.fn.extend({
        ...
        off: function(types, selector, fn) {
            ...
            return this.each(function(ARG1) {
