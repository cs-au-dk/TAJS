...
(function(global, factory) {
    ...
    jQuery.extend({
        ...
        expando: "jQuery" + (version + "TAJS_RANDOM_1").replace(/\D/g, ""),
 ...
 */
    function(window) {
        ...
        expando = "sizzle" + "TAJS_DATE_1", preferredDoc = window.document, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), sortOrder = function(a, b) {
            if (a === b) {
                "dk.brics.tajs.directives.unreachable";
                hasDuplicate = true;
            }
    ...
    function ajaxExtend(target, src) {
        ...
        for (key in src) {
            if (src[key] !== undefined) {
                (flatOptions[key] ? target : deep)[key] = src[key];
            }
        }
        if (deep) {
