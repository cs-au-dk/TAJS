...
(function(window, undefined) {
    ...
    core_deletedIds = [], core_version = "1.9.0", // Save a reference to some core methods
 ...
 */
    jQuery.event = {
        ...
        add: function(elem, types, handler, data, selector) {
            "dk.brics.tajs.directives.unreachable";
            var handleObjIn, eventHandle, tmp, events, t, handleObj, special, handlers, type, namespaces, origType, // Don't attach events to noData or text/comment nodes (but allow plain objects)
 ...
 */
    (function(window, undefined) {
        ...
        expando = "sizzle" + "TAJS_UUID", preferredDoc = window.document, support = {}, dirruns = 0, done = 0, classCache = createCache(), tokenCache = createCache(), compilerCache = createCache(), // General-purpose constants
        ...
        }, rsibling = /[\x20\t\r\n\f]*[+~]/, rnative = /\{\s*\[native code\]\s*\}/, // Easily-parseable/retrievable ID or TAG or CLASS selectors
 ...
 */
    ...
    jQuery.extend({
        ...
        buildFragment: function(elems, context, scripts, selection) {
            "dk.brics.tajs.directives.unreachable";
            var contains, elem, tag, tmp, wrap, tbody, j, l = elems.length, // Ensure a safe fragment
    ...
    var curCSS, getStyles, iframe, ralpha = /alpha\([^)]*\)/i, ropacity = /opacity\s*=\s*([^)]*)/, rposition = /^(top|right|bottom|left)$/, // swappable if display is none or starts with table except "table", "table-cell", or "table-caption"
 ...
 */
    ...
    function ajaxConvert(s, response) {
        "dk.brics.tajs.directives.unreachable";
        var conv, conv2, current, tmp, converters = {}, i = 0, // Work with a copy of dataTypes in case we need to modify it for conversion
