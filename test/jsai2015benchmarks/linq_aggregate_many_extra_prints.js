...
test("Aggregate", function () {
    actual = Enumerable.Range(1, 10).Aggregate(function (a, b) {
        //print(a);
        //print(b);
        return a + b;
    });
    //print(actual);
    equal(actual, 55);
    actual = Enumerable.Range(1, 10).Aggregate(10, function (a, b) {
        //print(a);
        //print(b);
        return a + b;
    });
...
test("Average", function () {
    ...
    //print(actual);
    equal(actual, 5.5);
    actual = Enumerable.Range(1, 10).Select(function (v, i) {
        //print(i);
        //print(v);
        return {
            v: v,
...
test("Count", function () {
    ...
    //print(actual);
    equal(actual, 0);
    actual = Enumerable.Range(1, 10).Count(function (i) {
        //print(i);
        return i < 5;
    });
    //print(actual);
