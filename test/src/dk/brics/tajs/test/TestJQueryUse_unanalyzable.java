...
public class TestJQueryUse_unanalyzable {
    ...
    private void test(String testCase) {
        ...
        try {
            Misc.run("benchmarks/tajs/src/jquery-use-autogenerated/" + testCase + ".snippet_in_plain.htm.dir/index.htm", CompositeMonitoring.buildFromList(Monitoring.make(), analysisLimiter));
